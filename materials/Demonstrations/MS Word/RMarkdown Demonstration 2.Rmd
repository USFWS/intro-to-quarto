...
This section needs to follow a unique format to allow us to highlight a very important statement!
...
## Kable Package
```{r Effort Summary Kable,echo=TRUE}
...
```{r EffortSummaryFlextable,echo=TRUE}
...
```{r CatchSummary, fig.height=4.0, fig.width=7.0, fig.cap="Figure 1. An example of a figure that was created using ggplot.",echo=TRUE}
...
```{r ggplotparameters,echo=TRUE, fig.height=4.0, fig.width=7.0, fig.cap= paste("Figure 2. An example of a figure that was created using ggplot with parameters",": ", params$SPECIES," ", "during"," ", params$YEAR,".",sep="")}
